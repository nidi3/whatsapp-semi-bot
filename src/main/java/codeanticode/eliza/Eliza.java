...
public class Eliza {
    ...
    public boolean readDefaultScript() throws IOException {
        clearScript();
    ...
    public boolean readScript(String script) throws IOException {
        clearScript();
        final BufferedReader in = new BufferedReader(new InputStreamReader(Thread.currentThread().getContextClassLoader().getResourceAsStream(script)));
        String line;
